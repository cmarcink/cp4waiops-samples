...
--       EXAMPLE:    psql -d postgres -f postgres/reporter_aiops_alerts_remove.sql
--------------------------------------------------------------------------------
...
------------------------------------------------------------------------------
DROP TRIGGER ALERTS_AUDIT_INSERT ON ALERTS_REPORTER_STATUS ;

DROP TRIGGER ALERTS_AUDIT_UPDATE_SEVERITY ON ALERTS_REPORTER_STATUS ;

DROP TRIGGER ALERTS_AUDIT_UPDATE_OWNER ON ALERTS_REPORTER_STATUS ;

DROP TRIGGER ALERTS_AUDIT_UPDATE_TEAM ON ALERTS_REPORTER_STATUS ;

DROP TRIGGER ALERTS_AUDIT_UPDATE_ACK ON ALERTS_REPORTER_STATUS ;

------------------------------------------------------------------------------
-- Drop functions related to alerts.
------------------------------------------------------------------------------
DROP FUNCTION ALERTS_AUDIT_INSERT_FN ;

DROP FUNCTION ALERTS_AUDIT_UPDATE_SEVERITY_FN ;

DROP FUNCTION ALERTS_AUDIT_UPDATE_OWNER_FN ;

DROP FUNCTION ALERTS_AUDIT_UPDATE_TEAM_FN ;

DROP FUNCTION ALERTS_AUDIT_UPDATE_ACK_FN ;
...
DROP TABLE ALERTS_REPORTER_STATUS CASCADE ;
